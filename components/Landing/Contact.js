export default function Contact() {
    return (
        <section className="h-[80vh] bg-cover bg-[url('/svg/pattern-white.svg')]">
            <div className="flex h-full w-full items-center justify-center container mx-auto px-2">
                <div className="md:max-w-2xl text-center select-none w-full">
                    <h1 style={{ fontFamily: "Montserrat-Bold"}} className="text-4xl sm:text-5xl text-black lg:text-6xl m-0"></h1>
                    <h1 style={{ fontFamily: "Montserrat-Bold"}} className="text-4xl sm:text-5xl text-[#1C60E4] lg:text-6xl m-0 md:m-2"></h1>
                    <p style={{ fontFamily: "Montserrat-Light"}} className="md:mt-6 lg:text-lg text-[#717171] sm:text-xl"></p>

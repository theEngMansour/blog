        ...
        <section className="py-6 bg-white">
            <div className="container px-4 mx-auto">
                <div className="text-center">
                    <h1 style={{ fontFamily: "Montserrat-Bold"}} className="max-w-3xl mx-auto text-4xl font-bold text-center md:text-6xl lg:text-7xl mb-0 selection:bg-[#d70133] selection:text-white"><FormattedMessage id={'header.title'}/><br className="hidden lg:inline" /><span className="text-red-500"> <FormattedMessage id={'header.subtitle'}/></span></h1>
